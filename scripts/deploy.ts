...
//   }
  ...
  /********************************** Deploy Margined Insurance Fund Contract *****************************************/
...
//   deployConfig.councilInitMsg.config.address_provider_address = insuranceFundContractAddress
//   const councilContractAddress = await deployContract(
//     terra,
//     wallet,
//     join(MARGINED_ARTIFACTS_PATH, 'mars_council.wasm'),
