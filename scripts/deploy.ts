...
import { deployContract, recover, setTimeoutDuration } from './helpers.js'
...
async function main() {
  ...
  console.log(deployConfig.priceFeedInitMsg)
  deployConfig.priceFeedInitMsg.address_provider_address = insuranceFundContractAddress
  ...
  //   deployConfig.vestingInitMsg.address_provider_address = insuranceFundContractAddress
  //   const vestingContractAddress = await deployContract(
  //     terra,
  //     wallet,
  //     join(MARGINED_ARTIFACTS_PATH, 'mars_vesting.wasm'),
  ...
  //   deployConfig.stakingInitMsg.config.address_provider_address = insuranceFundContractAddress
  //   const stakingContractAddress = await deployContract(
  //     terra,
  //     wallet,
  //     join(MARGINED_ARTIFACTS_PATH, 'mars_staking.wasm'),
  ...
  //     terra,
  //     wallet,
  //     join(MARGINED_ARTIFACTS_PATH, 'mars_safety_fund.wasm'),
  ...
  //     terra,
  //     wallet,
  //     join(MARGINED_ARTIFACTS_PATH, 'mars_treasury.wasm'),
  ...
  //     terra,
  //     wallet,
  //     join(MARGINED_ARTIFACTS_PATH, 'mars_incentives.wasm'),
  //     {
  //       "owner": councilContractAddress,
  //       "address_provider_address": insuranceFundContractAddress
  //     },
  //   )
  ...
  //     terra,
  //     wallet,
  //     join(MARGINED_ARTIFACTS_PATH, 'mars_xmars_token.wasm')
  //   )
  ...
  //     terra,
  //     wallet,
  //     join(MARGINED_ARTIFACTS_PATH, 'mars_ma_token.wasm')
  //   )
  ...
  //   deployConfig.protocolRewardsCollectorInitMsg.config.address_provider_address = insuranceFundContractAddress
  //   const protocolRewardsCollectorContractAddress = await deployContract(
  //     terra,
  //     wallet,
  //     join(MARGINED_ARTIFACTS_PATH, 'mars_protocol_rewards_collector.wasm'),
  ...
  //   deployConfig.redBankInitMsg.config.address_provider_address = insuranceFundContractAddress
  //   deployConfig.redBankInitMsg.config.ma_token_code_id = maTokenCodeId
  //   const redBankContractAddress = await deployContract(
  //     terra,
  //     wallet,
  //     join(MARGINED_ARTIFACTS_PATH, 'mars_red_bank.wasm'),
  ...
  //     terra,
  //     wallet,
  //     join(MARGINED_ARTIFACTS_PATH, 'mars_oracle.wasm'),
  //     {
  ...
  //   /**************************************** Update Config in Insurance Fund Contract *****************************************/
  //   console.log('Setting addresses in Insurance Fund')
  //   await executeContract(
  //     terra,
  //     wallet,
  ...
  //     }
  //   )
  //   console.log("Insurance Fund config successfully setup: ", await queryContract(terra, insuranceFundContractAddress, { "config": {} }))
