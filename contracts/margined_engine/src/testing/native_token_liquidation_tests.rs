...
//                 amount: Uint128::from(1_000_000900),
//                 expires: None,
//             },
//             &[],
//         )
...
//     let insurance_balance = router.wrap().query_balance(&insurance_fund.addr(), "uusd").unwrap().amount;
...
//         .position(&router, vamm.addr().to_string(), alice.to_string())
//         .unwrap();
//     assert_eq!(position.notional, Uint128::from(100u_000_00064));
...
//                 amount: Uint128::from(1000_000_000u64),
//             },
//             &[],
//         )
//         .unwrap();
...
//                 spender: env.engine.addr().to_string(),
//                 amount: Uint128::from(_000_000100),
//                 expires: None,
//             },
//             &[],
//         )
