...
fn test_is_false_if_less_than_ten_percent() {
    ...
    let price = Uint128::from(10_500_000_000u128);
    let timestamp = 1_000_000_000;
    ...
    let price = Uint128::from(9_500_000_000u128);
    let timestamp = 1_000_000_000;
